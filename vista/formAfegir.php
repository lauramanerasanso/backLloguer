    ...
    <div class="container" id="c">
        ...
        <div class="tab-content" id="myTabContent">
            ...
            <div class="tab-pane fade" id="imatges" role="tabpanel" aria-labelledby="imatges-tab">
                <div class="container">
                    <form method="post" id="myForm" action="../API/casa/insert_fotos.php" enctype="multipart/form-data">
                        <h4 style="margin-top: 2%;">Imatges :</h4>
                        <div class="row" style="margin-top: 2%;">
                            <div class="col-md-6">
                                <div class="custom-file">
                                    <input type="file" class="custom-file-input" data-target="file-uploader" id="file" name="file">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="custom-file">
                                    <input type="file" class="custom-file-input" data-target="file-uploader" id="f2" name="f2">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="custom-file">
                                    <input type="file" class="custom-file-input" data-target="file-uploader" id="f3" name="f3">
                                    <label class="custom-file-label" for="customFile">Imatge 3</label>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="custom-file">
                                    <input type="file" class="custom-file-input" data-target="file-uploader" id="f4" name="f4">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="custom-file">
                                    <input type="file" class="custom-file-input" data-target="file-uploader" id="f5" name="f5">
